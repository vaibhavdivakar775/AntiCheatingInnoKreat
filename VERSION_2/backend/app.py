...
from models import add_exam_report

from flask import render_template
from models import ExamReport, SessionLocal
...
object_model = YOLO(r"/Users/rahul/work/AntiCheatingInnoKreat/VERSION_1/models/weights")#-------------------change this according to location
...
def view_reports():
    ...
    try:
        reports = session.query(ExamReport).all()
    finally:
        session.close()
